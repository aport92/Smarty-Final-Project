...
import ForgotPass from '../forgot-password/Forgot-pass.gif';
...
const ForgotPass = () => {
  ...
  <div className="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
    <div className="flex flex-col overflow-y-auto md:flex-row">
      ...
      <img src={ForgotPass} alt="" className="object-cover object-center"/>
      </div>
      <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
        <div className="w-full">
          <h1 className="block mb-2 text-xl font-font1 text-mainblue">Olvidé mi contraseña</h1>
          <label className="block mb-2 font-font2 text-mainblue">
          ...
          <Link className="block w-full px-4 py-2 mt-4 text-sm font-font2 leading-5 text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg hover:bg-blue-800 focus:outline-none focus:shadow-outline-darkblue"
            to={"./InicioSesion"}>Recuperar Contraseña</Link>
        </div>
      </div>
    </div>
  </div>
