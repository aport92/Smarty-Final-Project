...
export const AdministrarInstitucion = () => {
  return (
        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            <tr>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p class="text-gray-900 whitespace-no-wrap">Privado</p>
              </td>
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p class="text-gray-900 whitespace-no-wrap">San Salvador</p>
              </td>
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p class="text-gray-900 whitespace-no-wrap">San Salvador</p>
              </td>
              ...
              <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <BotonEditar tipo="editarInstitucion" />
...
export default AdministrarInstitucion;
