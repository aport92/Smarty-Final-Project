              ...
              <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <img src={imgHome} alt="" class="object-cover object-center rounded"/>
                  ...
                  <section className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 className=" sm:text-3xl text-3xl mb-4 text-blue-600"> ¡Aprender Siempre es genial!</h1>
                      <Link>
                              ...
                              <Link>
                                  ...
                                  <Link>
                                      ...
                                      <div className="mt-3  p-2 flex justify-center gap-x-6">
                                          <Link to="/Registro" ID="link" className="rounded-md bg-blue-600 px-10 py-2.5 text-xl font-font2 text-white shadow-sm hover:bg-mainblue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Registrate</Link>
                                            <Link to="/InicioSesion" ID="link"className="rounded-md bg-blue-600 px-6 py-2.5 text-xl font-font2 text-white shadow-sm hover:bg-mainblue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Iniciar sesión</Link>
                                      </div>
                      </section>
                </div>
          </section>
