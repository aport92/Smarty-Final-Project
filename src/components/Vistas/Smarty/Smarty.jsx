...
<section className="text-gray-400 body-font">
    <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <p className="title-font sm:text-md text-md mb-4 font-sm text-gray-600"><strong className='text-xl font-bold text-blue-600'>¿Qué es Smarty?</strong>
            <br/>Es una aplicación web que te ayudará a fortalecer tus conocimientos de una manera fácil y divertida. Con <strong className='font-bold text-blue-500'>Smarty</strong>, podrás responder cuestionarios de las diferentes materias de ciencias de tu grado y recibir un puntaje por cada uno. Además, podrás personalizar tu perfil con tu foto y ganar insignias según el avance que tengas en los diferentes niveles de cuestionarios y la frecuencia con la que uses la aplicación.
            <br/><br/>
            La ventaja de <strong className='font-bold text-blue-500'>Smarty</strong> es que podrás utilizarla desde cualquier dispositivo conectado a internet y en cualquier momento que tengas libre. También podrás ver tus avances y métricas de uso, como el tiempo que pasaste en la aplicación y tu nivel de satisfacción con la misma.
            </p>
