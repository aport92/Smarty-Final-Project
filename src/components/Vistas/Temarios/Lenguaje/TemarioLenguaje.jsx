      ...
      <section className="text-gray-400 bg-white body-font overflow-hidden">
        ...
        <div className="py-8 flex  flex-wrap md:flex-nowrap p-20">
          <div className="md:flex-grow">
            <h2 className="text-2xl font-medium text-mainblue title-font mb-2">¿Qué es un texto narrativo?</h2>
        ...
        <Link to={"/QuizzLiteratura"} className="text-mainblue">Relizar Test
